...
@section('content')
    <div class="row">
        <h3 class="text-center text-info">Ex Chief Instructor Data <a class="btn btn-default" href="{{url('/allExChiefinstructorReport')}}">Print all Info</a></h3>
        <hr>
        @foreach(array_chunk($exChiefinstructor->all(),3) as $row)
            <div class="row">
