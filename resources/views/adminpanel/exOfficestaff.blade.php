...
@section('content')
    <div class="row">
        <h3 class="text-center text-info">Ex Office Staff Data <a class="btn btn-default" href="{{url('/allExOfficestaffReport')}}">Print all Info</a></h3>
        <hr>
        @foreach(array_chunk($exOfficestaff->all(),3) as $row)
            <div class="row">
