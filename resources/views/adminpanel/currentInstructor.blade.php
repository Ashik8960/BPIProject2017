...
@section('content')
    <div class="row">
        <h3 class="text-center text-info">Current Instructor Data <a class="btn btn-default" href="{{url('/allCurrentInstructorReport')}}">Print all Info</a></h3>
        <hr>
        @foreach(array_chunk($currentInstructor->all(),3) as $row)
            <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="overlay">
                            ...
                            <ul>
                                ...
                                <li><strong>Designation: </strong>{{$s->status}} {{$s->designation}}{{$s->designation}}{{$s->helper_post}}</li>
                            </ul>
                            <div class="changling-step">
                                <div class="btn-group">
                                    ...
                                    <a href="{{url('/moveOnCurrent/'.$s->id)}}" class="btn btn-success">Move again
