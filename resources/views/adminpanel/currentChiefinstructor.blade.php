...
@section('content')
    <div class="row">
        <h3 class="text-center text-info">Current Chief Instructor Data <a class="btn btn-default" href="{{url('/allCurrentChiefinstructorReport')}}">Print all Info</a></h3>
        <hr>
        @foreach(array_chunk($currentChiefinstructor->all(),3) as $row)
            <div class="row">
