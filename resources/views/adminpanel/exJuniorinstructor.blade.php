...
@section('content')
    <div class="row">
        <h3 class="text-center text-info">Ex Junior Instructor Data <a class="btn btn-default" href="{{url('/allExJuniorinstructorReport')}}">Print all Info</a></h3>
        <hr>
        @foreach(array_chunk($exJuniorinstructor->all(),3) as $row)
            <div class="row">
