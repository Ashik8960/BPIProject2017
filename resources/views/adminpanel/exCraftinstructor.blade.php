...
@section('content')
    <div class="row">
        <h3 class="text-center text-info">Ex Craft Instructor Data <a class="btn btn-default" href="{{url('/allExCraftinstructorReport')}}">Print all Info</a></h3>
        <hr>
        @foreach(array_chunk($exCraftinstructor->all(),3) as $row)
            <div class="row">
