...
@section('content')
    <div class="row">
        <h3 class="text-center text-info">Current Craft Instructor Data <a class="btn btn-default" href="{{url('/allCurrentCraftinstructorReport')}}">Print all Info</a></h3>
        <hr>
        @foreach(array_chunk($currentCraftinstructor->all(),3) as $row)
            <div class="row">
