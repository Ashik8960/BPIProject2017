...
@section('content')
    <div class="row">
        <h3 class="text-center text-info">Ex Instructor Data <a class="btn btn-default" href="{{url('/allExInstructorReport')}}">Print all Info</a></h3>
        <hr>
        @foreach(array_chunk($exInstructor->all(),3) as $row)
            <div class="row">
