...
@section('content')
    <div class="row">
        <h3 class="text-center text-info">Current Office Staff Data <a class="btn btn-default" href="{{url('/allCurrentOfficestaffReport')}}">Print all Info</a></h3>
        <hr>
        @foreach(array_chunk($currentOfficestaff->all(),3) as $row)
            <div class="row">
