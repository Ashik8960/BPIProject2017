...
@section('content')
    <div class="row">
        <h3 class="text-center text-info">Ex Vice Principle Data <a class="btn btn-default" href="{{url('/allExViceprincipleReport')}}">Print all Info</a></h3>
        <hr>
        @foreach(array_chunk($exViceprinciple->all(),3) as $row)
            <div class="row">
